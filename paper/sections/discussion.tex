...
\eqref{eq:pfm_block}.} However, given the equivalence of the temporal
...
\citep{ortelli2019synthesis}. Still, we have shown that
...
the MAD selection of $\lambda$. However, since their regularization paths are
...
designs \citep{Yesilyurt2008DynamicsnonlinearitiesBOLD,
