...
\begin{figure}[h]
    ...
    \end{center}
    \caption{Simulated signal with different SNRs (20 dB, 10 dB and 3 dB)\todo[inline]{Why not combine this in a single plot with different lines/colors for the SNR levels?}.}
...
\begin{figure}[h]
    ...
    \end{center}
    \caption{Most representative voxel of the finger-tapping task. Green blocks indicate the onsets and the duration of it.\todo[inline]{This image does not look complete here?}}
...
At the same time, we evaluate the performance of PFM and TA with respect to a GLM that takes advantage of the duration and onsets of the stimuli in the motor task data. Given the block design of the motor task, we make this comparison with the block model only.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Beyond deconvolution}
Finally, we show the usefulness of deconvolution approaches by using the activity-inducing and innovation signals obtained and performing aco-activation patterns (CAPs) and innovation-driven co-activation patterns (iCAPs) analysis. We then compare the results with the widely-used seed-based correlation approach.