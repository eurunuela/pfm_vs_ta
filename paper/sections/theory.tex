...
Alternatively, the backward model formulation relies upon a differential operator to invert the convolution by the HRF, and can be seen as a denoising problem with tailored regularization.
