...
\begin{figure}[t!]
    ...
    \end{center}
    \caption{Flowchart detailing the different steps of the fMRI signal and the deconvolution methods described. The orange arrows indicate the flow to estimate the innovation signals. The blue box depicts the two algorithms used in this paper to solve the PFM and TA deconvolution problems. \textbf{I would remove the orange lines. We might need to add more details to the blue box, what's plotted in each figure (i.e. lines, etc)?}}
\label{fig:flowchart}
\end{figure}
