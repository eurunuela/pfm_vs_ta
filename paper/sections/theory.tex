...
\end{equation}
and becomes equivalent to the block model formulation of TA by replacing $\mathbf{u}=\mathbf{D D_H x}$ in Eq. (\ref{eq:TA}). This work evaluates the core of the two techniques, i.e., the regularized least-squares problem with temporal regularization without considering the spatial regularization term originally incorporated in TA.
